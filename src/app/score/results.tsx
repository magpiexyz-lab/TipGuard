  ...
  return (
    <div className="pb-24">
      ...
      <section aria-labelledby="verdict-heading" className="mx-auto max-w-[1120px] px-6 pt-10">
        <div className="grid items-center gap-8 rounded-xl bg-card p-6 ring-1 ring-foreground/10 sm:p-8 md:grid-cols-[240px_1fr] md:gap-12">
          ...
          <div>
            ...
            <h2
              id="verdict-heading"
              className="mt-3 text-3xl leading-tight sm:text-[44px] sm:leading-[1.1]"
            >
              {verdictSentence(result, claimsTipCredit)}
            </h2>
            <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
              {claimsTipCredit
                ? "Every point deducted below maps to a specific document an investigator can ask for and you cannot currently produce."
                : "Paying the full minimum wage in cash removes the tip-credit exposure entirely. The checks below still matter if you ever move to a sub-minimum cash wage."}
            </p>
      ...
      <section aria-labelledby="state-rule-heading" className="mx-auto max-w-[1120px] px-6 pt-14">
        ...
        <h2 id="state-rule-heading" className="mt-3 text-2xl sm:text-3xl">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-foreground">
                ...
                <span data-evidence>{usd.format(supportedRule.standardMinimumWage)}</span> must be
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-3">
          {!supportedRule ? (
            ...
            <>
              <RuleCell label="Cash wage floor" value={usd.format(supportedRule.cashWageFloor)} />
              <RuleCell
                label="Full minimum wage"
                value={usd.format(supportedRule.standardMinimumWage)}
              />
              <RuleCell
                label="Maximum tip credit"
                value={usd.format(supportedRule.maxTipCredit)}
                caption={
      ...
      <section aria-labelledby="gaps-heading" className="mx-auto max-w-[1120px] px-6 pt-14">
        <p className="eyebrow">Ranked by points lost</p>
        <h2 id="gaps-heading" className="mt-3 text-2xl sm:text-3xl">
      ...
      <section aria-label="Save your score" className="mx-auto max-w-[1120px] px-6 pt-14">
        <div className="overflow-hidden rounded-xl">
          <div className="surface-ink texture-rule bloom-brass p-8 sm:p-12">
            ...
            <h2 className="mt-3 max-w-2xl text-3xl leading-tight text-[#ECE8DA] sm:text-[40px]">
              Save my score and fix these gaps
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-[#A8AF9B]">
              Creating an account carries this score and gap list onto your restaurant, then
              generates the state-specific notices your staff can sign. Free — the $79/mo plan is
              for the audit-file export, not for closing the gaps.
            </p>
